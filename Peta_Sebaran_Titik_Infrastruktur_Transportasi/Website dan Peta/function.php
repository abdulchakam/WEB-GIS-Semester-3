...
//membuat fungsi tambah data
function tambah_data($p_id,$p_kat,$p_nama,$p_alamat,$p_lat,$p_lng){	
			
	//buat perintah sql
	$sql="INSERT INTO $this->tbl VALUES('$p_id','$p_kat','$p_nama','$p_alamat','$p_lat','$p_lng')";
...
public function edit_data($id){
    ...
    public function update($sv_id, $sv_kat,$sv_nama, $sv_alamat, $sv_lat, $sv_lng){
      
      $sql="UPDATE $this->tbl SET Id='$sv_id', Kategori='$sv_kat', Nama='$sv_nama', Alamat='$sv_alamat', Lattitude='$sv_lat', Longitude='$sv_lng' WHERE Id='$sv_id' ";
      $stmt=$this->db->prepare($sql);
      $stmt->execute();
