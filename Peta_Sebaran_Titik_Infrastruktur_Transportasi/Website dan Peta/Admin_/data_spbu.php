                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <a href="../Peta_TitikSpbu" target="_blank" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i>
                                &nbsp; Lihat Peta </a>
                        </ul>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td width="150px">
                            ...
                            <a class="btn btn-outline-danger btn-sm m-1"
                                href="hapusDataSpbu.php?qid=<?php echo $row['Id'] ?>"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <form action="save_editDataSpbu.php?qid=<?php echo $row['Id'] ?>" method="post"
							...
							?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="flat" id="flat"
                                                    value="<?php echo $row['Lattitude']; ?>" required>
                                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="save_addDataSpbu.php" method="post" class="col-sm-10 m-auto">
